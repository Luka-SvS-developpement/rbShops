...
RageUI.Settings = {
    ...
    Items = {
        Title = {
            Background = { Width = 500, Height = 85 },
            Text = { X = 250, Y = 3.5, Scale = 1.05 },
        },
        Subtitle = {
            Background = { Width = 500, Height = 3 },
            Text = { X = 8, Y = 0.80, Scale = 0 },
            PreText = { X = 425, Y = 3, Scale = 0 },
        },
        ...
        Description = {
            Bar = { Y = 4, Width = 500, Height = 0.0 },
            Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 1.5, Width = 500, Height = 20 },
            Text = { X = 8.9, Y = 3, Scale = 0.27 },
        },
    },
    Panels = {
        Grid = {
