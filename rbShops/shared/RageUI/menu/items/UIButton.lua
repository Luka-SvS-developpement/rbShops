...
local SettingsButton = {
    Rectangle = { Y = 0, Width = 500, Height = 30 },
    Text = { X = 8, Y = 1.2, Scale = 0.31 },
    LeftBadge = { Y = -2, Width = 40, Height = 40 },
    RightBadge = { X = 455, Y = -3.5, Width = 40, Height = 37 },
    RightText = { X = 490, Y = 1.2, Scale = 0.33 },
    SelectedSprite = { Dictionary = "commonmenu", Texture = "gradient_nav", Y = 0, Width = 500, Height = 30 },
}
