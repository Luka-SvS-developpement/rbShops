...
---@return RageUIMenus
---@public
function RageUI.CreateMenu(Title, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Rectangle = nil
    Menu.Pagination = { Minimum = 1, Maximum = 20, Total = 20 }
    Menu.Safezone = true
...
---@return RageUIMenus
---@public
function RageUI.CreateSubMenu(ParentMenu, Title, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
            local Menu = RageUI.CreateMenu(Title or ParentMenu.Title, X or ParentMenu.X, Y or ParentMenu.Y)
